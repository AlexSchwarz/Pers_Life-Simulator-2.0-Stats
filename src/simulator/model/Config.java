...
public final class Config {
    ...
    public static final int WOLF_INTRODUCTION_DAY = 300;
    ...
    public static final double RABBIT_MOVE_CHANCE =     1;
    ...
    public static final double WOLF_MATE_CHANCE =   1;
    public static final double WOLF_FEED_CHANCE =   0.05;
    public static final double WOLF_MOVE_CHANCE =   1;
